...
- **Keep Roman Reinforcement Soldiers**: Standalone feature that leaves Roman reinforcement squads at the camp as garrison while pack horses and civilians depart normally. It still applies the P8 threshold and P9 handoff atomically so retained squads do not stop later waves prematurely; legacy `EndlessAi.M6` settings migrate automatically.
