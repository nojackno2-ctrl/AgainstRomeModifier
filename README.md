...
- **Experimental Native Widescreen**: Replaces the native 1600×1200 32-bit mode with 1920×1080 so the engine receives a real widescreen viewport instead of a stretched 4:3 frame. Apply/detect/restore and static tests are complete; expanded world view, UI placement, mouse hit-testing, edge scrolling, and minimap behavior still require in-game verification.
