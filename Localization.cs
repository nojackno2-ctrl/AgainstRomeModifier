...
namespace AgainstRomeModifier {
    ...
    public static class Loc {
        ...
        private static readonly Dictionary<string, string> Zh = new Dictionary<string, string> {
            ...
            { "AiUltimateMode", "AI終極模式（無限增援、重生 5 秒、上場上限 8）" },
            ...
            { "LogEndlessAiUltimateApplied", "AI終極模式已套用：{0} 個無盡腳本的軍隊數量改為 {1}；完成的增援工作會自動回收，重生等待為 5 秒，同時上場上限為 8；全域生產腳本維持原版以避免玩家資源停產。" },
        ...
        private static readonly Dictionary<string, string> En = new Dictionary<string, string> {
            ...
            { "AiUltimateMode", "AI Ultimate Mode (Infinite Reinforcements, 5s Respawn, Active Limit 8)" },
            ...
            { "LogEndlessAiUltimateApplied", "AI Ultimate Mode applied in {0} endless scripts: army count {1}, completed reinforcement jobs recycle, respawn wait is 5 seconds, and active-party limit is 8; global production scripts remain original to protect player resource output." },
