...
namespace AgainstRomeModifier {
    ...
    public static class Loc {
        ...
        private static readonly Dictionary<string, string> Zh = new Dictionary<string, string> {
            ...
            { "RomanReinforcementGarrison", "羅馬增援士兵留守" },
...
{ "LogSpellRange3xToggled", "法師法術範圍提升 3 倍已{0}。" },
            ...
            { "RomanReinforcementGarrisonTip", "讓無盡模式的羅馬增援抵達後，士兵小隊留在營地擔任守軍，馱馬與平民依原路離場。功能會一併提高增援單位門檻，避免留守士兵導致後續增援過早停止。只影響新開無盡局；舊存檔需在存檔管理員執行「修復無盡 AI」。" },
        ...
        private static readonly Dictionary<string, string> En = new Dictionary<string, string> {
            ...
            { "RomanReinforcementGarrison", "Keep Roman Reinforcement Soldiers" },
...
{ "LogSpellRange3xToggled", "3x Spell Effect Radius {0}." },
            ...
            { "RomanReinforcementGarrisonTip", "Keeps Roman reinforcement squads at the camp as garrison while pack horses and civilians leave normally. The reinforcement unit threshold is raised with the handoff patch so retained squads do not stop later waves prematurely. Affects new endless games only; use Repair Endless AI in Save Manager for an existing save." },
