...
namespace AgainstRomeModifier {
    ...
    public static class Loc {
        ...
        private static readonly Dictionary<string, string> Zh = new Dictionary<string, string> {
            ...
            { "RangedRange3x", "遠程單位射程提升 3 倍 (實驗性)" },
            { "RangedRange3xTip", "將所有遠程步兵、遠程騎兵以及攻城武器的攻擊/射擊射程提升 3 倍。" },
            { "LogRangedRange3xToggled", "遠程單位射程提升 3 倍已{0}。" },
            { "UnitMovementSpeed2x", "單位移動速度提升 2 倍 (實驗性)" },
            { "UnitMovementSpeed2xTip", "將所有戰鬥單位（包括士兵、領袖、祭司）與平民單位（村民、馱馬）的移動速度提升 2 倍。" },
            { "LogUnitMovementSpeed2xToggled", "單位移動速度提升 2 倍已{0}。" },
{ "SpellEntireMap", "法師施法距離提升至全地圖 (實驗性)" },
{ "SpellEntireMapTip", "將所有祭司施放神術與復活術的最大施法距離提升至全地圖；不改變法術命中半徑。" },
{ "LogSpellEntireMapToggled", "法師施法距離提升至全地圖已{0}。" },
{ "SpellRange3x", "法師法術範圍提升 3 倍 (實驗性)" },
{ "SpellRange3xTip", "將法術的效果與命中範圍提升為原版的 3 倍；不改變祭司的施法距離。" },
{ "LogSpellRange3xToggled", "法師法術範圍提升 3 倍已{0}。" },
            { "ProjectileArcHeight", "拋射彈道增高 (實驗性)" },
            { "ProjectileArcHeightTip", "將箭矢、標槍與投石等拋射物的垂直初速與重力同步提升 1.5 倍：彈道弧頂增高約 5 成、更容易越過樹木與建築等障礙物，落點與飛行時間維持不變。敵我全陣營一體適用。" },
            { "RangedAccuracy", "遠程命中強化 (實驗性)" },
            { "RangedAccuracyTip", "將拋射物落點的傷害判定半徑加倍（近失彈也算命中），並將對移動目標預判的隨機散布歸零，大幅提升遠程單位實際命中率。敵我全陣營一體適用。" },
        ...
        private static readonly Dictionary<string, string> En = new Dictionary<string, string> {
            ...
            { "RangedRange3x", "3x Range for Ranged Units (Experimental)" },
            { "RangedRange3xTip", "Triples the attack and firing range of all ranged infantry, ranged cavalry, and siege weapons." },
            { "LogRangedRange3xToggled", "3x Range for Ranged Units {0}." },
            { "UnitMovementSpeed2x", "2x Movement Speed for Units (Experimental)" },
...
{ "SpellEntireMap", "Spell Casting Distance: Entire Map (Experimental)" },
...
{ "SpellRange3x", "3x Spell Effect Radius (Experimental)" },
...
{ "LogSpellRange3xToggled", "3x Spell Effect Radius {0}." },
            { "ProjectileArcHeight", "Higher Projectile Arc (Experimental)" },
            { "ProjectileArcHeightTip", "Raises projectile launch speed and gravity by 1.5x together: arrows, javelins and catapult stones fly ~50% higher arcs that clear trees and buildings, while landing point and flight time stay unchanged. Applies to all factions." },
            { "RangedAccuracy", "Ranged Accuracy Boost (Experimental)" },
            { "RangedAccuracyTip", "Doubles the impact damage radius of projectiles (near misses now hit) and removes the random lead-aim scatter against moving targets. Applies to all factions." },
