...
namespace AgainstRomeModifier {
    ...
    public static class Loc {
        ...
        private static readonly Dictionary<string, string> Zh = new Dictionary<string, string> {
            ...
            { "LeaderGloryKeepTip", "首領死亡並復活後仍保留原來的榮耀等級與體型，不會重製為 0。" },
            ...
            { "AiM3Tip", "無盡模式：AI 敗亡後快速清除舊村莊與城牆、加速死亡判定與撤退，並完整清除隊伍狀態後再重新入場。" },
        ...
        private static readonly Dictionary<string, string> En = new Dictionary<string, string> {
            ...
            { "LeaderGloryKeep", "Leader Glory Persistence" },
            ...
            { "LeaderGloryKeepTip", "Allows the tribal leader to retain their accumulated glory level and model size across death and respawn instead of resetting to 0." },
            ...
            { "AiM3Tip", "Endless mode: after an AI is defeated, quickly clears the old village and palisades, then fully clears team state before the slot is reused." },
