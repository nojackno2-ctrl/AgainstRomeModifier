...
namespace AgainstRomeModifier {
    ...
    public static class Loc {
        ...
        private static readonly Dictionary<string, string> Zh = new Dictionary<string, string> {
            ...
            { "AiUltimateMode", "AI終極模式（無限增援、5 秒冷卻、5–10 秒輪詢、上場上限 8）" },
            { "DgVoodoo", "啟用 dgVoodoo2 圖形相容層（自動安裝／移除）" },
            ...
            { "LogEndlessAiUltimateApplied", "AI終極模式已套用：{0} 個無盡腳本的軍隊數量改為 {1}；完成的增援工作會自動回收，重生冷卻為 5 秒、增援輪詢為 5–10 秒，同時上場上限為 8；其他 AI 行動與全域生產腳本維持原版。" },
            { "LogEndlessAiUltimateRestored", "AI終極模式已還原：{0} 個無盡腳本的軍隊數量、增援工作旗標、重生等待與同時上場上限均改回原始值；全域生產腳本亦維持原版。" },
        ...
        private static readonly Dictionary<string, string> En = new Dictionary<string, string> {
            ...
            { "InfiniteMorale", "Infinite Morale (No Decay & Rapid Recovery)" },
            { "HousingCapacity20x", "20x Capacity for All Population Buildings" },
            { "AiUltimateMode", "AI Ultimate Mode (Infinite Reinforcements, 5s Cooldown, 5-10s Polling, Active Limit 8)" },
            { "DgVoodoo", "Enable dgVoodoo2 graphics wrapper (automatic install/remove)" },
            ...
            { "LogEndlessAiUltimateApplied", "AI Ultimate Mode applied in {0} endless scripts: army count {1}, completed reinforcement jobs recycle, respawn cooldown is 5 seconds, reinforcement polling is 5-10 seconds, and active-party limit is 8; other AI actions and global production scripts remain original." },
            { "LogEndlessAiUltimateRestored", "AI Ultimate Mode restored in {0} endless scripts: army count {1}, reinforcement-job flag, respawn wait, and active-party limit returned to original values; global production scripts also remain original." },
