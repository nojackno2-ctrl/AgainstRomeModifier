...
namespace AgainstRomeModifier {
    ...
    public static class TroopConfig {
        ...
        public static readonly Dictionary<string, double[]> BalancedUnitStats = new Dictionary<string, double[]>(StringComparer.OrdinalIgnoreCase) {
            // Roman：整體素質最強。
            {"FigRomInf00_Lanze_Schild", new double[] {100, 20, 40, 50, 3.2, 1500, 500, 400, 0}},
            {"FigRomSch00_Speer_Schild", new double[] {100, 15, 80, 50, 3.2, 1500, 500, 900, 0}},
            {"FigRomInf01_Schwert_Schild", new double[] {100, 20, 80, 70, 3.2, 1500, 500, 400, 0}},
            {"FigRomSch01_Bogen", new double[] {100, 10, 50, 50, 3.2, 1500, 1300, 1200, 0}},
            {"FigRomKav00_Schwert_Schild", new double[] {100, 20, 80, 75, 3.2, 1500, 500, 400, 0}},
            {"FigRomAnf00_Anfuehrer", new double[] {400, 20, 100, 80, 2.6, 1500, 500, 128, 0}},
            {"FigRomArt00_Speerschleuder", new double[] {150, 175, 40, 60, 0, 1500, 3000, 1300, 0}},
            {"FigRomArt00_Speerschleuder_Auf", new double[] {150, 175, 40, 60, 0, 1500, 3000, 1300, 0}},
            {"FigRomArt01_Katapult", new double[] {300, 250, 40, 60, 0, 1500, 6000, 1200, 0}},
            {"FigRomArt01_Katapult_Aufbau", new double[] {300, 250, 40, 60, 0, 1500, 6000, 1200, 0}},

            // Teuton：近戰傷害與爆發最高。
            {"FigGerInf01_Schwert", new double[] {100, 12, 40, 20, 3.2, 1500, 500, 400, 0}},
            {"FigGerSch00_Speer", new double[] {100, 5, 25, 20, 3.2, 1500, 1500, 900, 0}},
            {"FigGerInf00_Hammer_Schild", new double[] {100, 12, 60, 20, 3.2, 1500, 500, 400, 0}},
            {"FigGerSch01_Axt_Schild", new double[] {100, 12, 80, 25, 3.2, 1500, 500, 700, 0}},
            {"FigGerInf02_Zweihandaxt", new double[] {100, 20, 50, 30, 3.2, 1500, 500, 400, 0}},
            {"FigGerKav00_Schwert_Schild", new double[] {100, 12, 90, 50, 3.2, 1500, 500, 400, 0}},
            {"FigGerInf03_Doppelhammer", new double[] {100, 30, 50, 40, 3.2, 1500, 500, 400, 0}},
            {"FigGerAnf00_Anfuehrer", new double[] {400, 20, 100, 30, 2.6, 1500, 500, 128, 0}},
            {"FigGerPri00_Priester", new double[] {100, 10, 70, 30, 2.6, 1500, 500, 1500, 0}},
            {"FigGerArt00_Katapult", new double[] {50, 150, 50, 50, 0, 1500, 5000, 1000, 0}},
            {"FigGerArt00_Katapult_Aufbau", new double[] {10, 150, 50, 0, 0, 1500, 5000, 1000, 0}},

            // Celt：步兵防禦與步行遠程最強，投石兵以高單發傷害輸出。
            {"FigKelInf00_Schwert", new double[] {100, 5, 85, 20, 3.2, 1500, 500, 400, 0}},
            {"FigKelSch00_Bogen", new double[] {100, 7.5, 30, 50, 3.2, 1500, 1250, 1100, 0}},
            {"FigKelInf01_Lanze", new double[] {100, 10, 90, 30, 3.2, 1500, 500, 400, 0}},
            {"FigKelSch01_Schleuder", new double[] {100, 25, 70, 65, 3.2, 1500, 1000, 1000, 0}},
            {"FigKelInf02_Doppelschwert", new double[] {100, 25, 70, 60, 3.2, 1500, 500, 400, 0}},
            {"FigKelSch02_Schwere_Schleuder", new double[] {100, 30, 70, 80, 3.2, 1500, 1500, 900, 0}},
            {"FigKelKav00_Lanze_Schild", new double[] {100, 20, 95, 75, 3.2, 1500, 500, 400, 0}},
            {"FigKelAnf00_Anfuehrer", new double[] {400, 20, 100, 60, 2.6, 1500, 500, 128, 0}},
            {"FigKelPri00_Priester", new double[] {100, 10, 80, 60, 2.6, 1500, 500, 1500, 500}},
            {"FigKelArt00_Speerschleuder", new double[] {150, 100, 40, 60, 0, 1500, 3000, 1100, 0}},
            {"FigKelArt00_Speerschleuder_A", new double[] {150, 100, 40, 60, 0, 1500, 3000, 1100, 0}},
            {"FigKelArt01_Katapult", new double[] {50, 175, 50, 50, 0, 1500, 5000, 1000, 0}},
            {"FigKelArt01_Katapult_Aufbau", new double[] {10, 175, 50, 0, 0, 1500, 5000, 1000, 0}},

            // Hun：騎兵整體最強，弓騎兵以低單發、高射速輸出。
            {"FigHunInf00_Keule", new double[] {100, 5, 20, 30, 3.2, 1500, 500, 400, 0}},
            {"FigHunSch00_Bogen", new double[] {100, 10, 20, 50, 3.2, 1500, 750, 1000, 0}},
            {"FigHunInf01_Schwert_Schild", new double[] {100, 10, 50, 50, 2.6, 1500, 500, 400, 0}},
            {"FigHunKav00_Schwert_Schild", new double[] {100, 15, 35, 40, 3.2, 1500, 500, 400, 0}},
            {"FigHunKav01_Bogen", new double[] {100, 10, 20, 70, 3.2, 1500, 500, 1000, 0}},
            {"FigHunKav02_Lanze_Schild", new double[] {100, 30, 60, 75, 3.2, 1500, 500, 400, 0}},
            {"FigHunKav03_Geisterreiter", new double[] {100, 15, 60, 60, 3.2, 1500, 500, 400, 0}},
            {"FigHunAnf00_Anfuehrer", new double[] {400, 20, 100, 50, 3.2, 1500, 500, 128, 0}},
            {"FigHunPri00_Priester", new double[] {100, 15, 30, 50, 2.6, 1500, 500, 1500, 500}}
        };
