...
int main() {
    ...
    const Prologue prologues[] = {
        ...
        {"bciop@5B1C60", {0x53, 0x56, 0x57, 0x55, 0x89, 0xE5, 0x81, 0xEC,
                          0xA8, 0x06, 0x00, 0x00}},
        {"npcquery@548D20", {0x8B, 0x44, 0x24, 0x04, 0x85, 0xC0, 0x7C, 0x14,
                             0x83, 0xF8, 0x08}},
        {"levelinit@54A070", {0x53, 0x56, 0x57, 0x55, 0x83, 0xEC, 0x24,
                              0xBB, 0x38, 0x91, 0x9C, 0x02}},
        {"battlemax@5249D0", {0x53, 0x56, 0x57, 0x55, 0x83, 0xEC, 0x0C,
                              0x8B, 0x54, 0x24, 0x24}},
        {"civimax@524D70", {0x53, 0x56, 0x57, 0x55, 0x83, 0xEC, 0x08,
                            0x8B, 0x6C, 0x24, 0x24}},
    };
